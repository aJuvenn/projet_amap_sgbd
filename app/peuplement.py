...
domains = ['enseirb-matmeca.fr', 'coucou.com', 'bonjour.net', 'salut.fr', 'hello.org', 'yo.io', 'hey.com', 'bonsoir.net', 'ciao.it', 'nihao.cn', 'ohayo.jp', 'hola.es', 'hallo.de', 'guten-tag.de', 'hi.us', 'eirb.fr', 'how-r-u.uk']

foyers = [('Enseirb-Matmeca', 'La meilleure école'), ('Pizza House', 'La maison de la pizza'), ('Cake Mansion', 'Le manoir du gâteau'), ('Sausage Stadium', 'Un stade dans lequel on mange de la saucisse'), ('JDR/JDS Foyer', 'pour la blague'), ('Le bar du coin', 'c est un point relais'), ('Chez Paul', 'ça sent pas bon mais il reste réceptionner le colis'), ('Au RU1', 'Si tu n as pas peur de faire la queue'), ('Doughnut Park', 'Pour une promenade de santé'), ('Bier Garten', 'Chez nos amis allemands'), ('Club Zik', 'Chez les musiciens'), ('BDA', 'Les artistes'), ('Eirbware', 'Ils font des trucs expérimentaux'), ('AEI', 'Qui n a toujours pas rendu l argent')]
